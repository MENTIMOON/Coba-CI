...
class User extends CI_Controller
{
    ...
    public function ikm()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('user/v_data_ikm', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function pasar()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('user/v_data_pasar', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function ekspor()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('user/v_data_eksportir', $data);
        $this->load->view('layouts/footer', $data);
    }
    ...
    public function sentraBT()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('bantul/user/v_sentra_bt', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function pasarBT()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('bantul/user/v_pasar_bt', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function eksporBT()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('bantul/user/v_eksportir_bt', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function sentraGK()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('gunungkidul/user/v_sentra_gk', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function pasarGK()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('gunungkidul/user/v_pasar_gk', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function eksporGK()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('gunungkidul/user/v_eksportir_gk', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function sentraKP()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('kulonprogo/user/v_sentra_kp', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function pasarKP()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('kulonprogo/user/v_pasar_kp', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function eksporKP()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('kulonprogo/user/v_eksportir_kp', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function sentraSL()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('sleman/user/v_sentra_sl', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function pasarSL()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('sleman/user/v_pasar_sl', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function eksporSL()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('sleman/user/v_eksportir_sl', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function sentraYK()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('yogyakarta/user/v_sentra_yk', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function pasarYK()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('yogyakarta/user/v_pasar_yk', $data);
        $this->load->view('layouts/footer', $data);
    }
    public function eksporYK()
    {
        ...
        $this->load->view('layouts/header_user', $data);
        $this->load->view('yogyakarta/user/v_eksportir_yk', $data);
        $this->load->view('layouts/footer', $data);
    }
}
