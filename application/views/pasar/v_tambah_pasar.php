        ...
        <div class="col-sm-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?= base_url('data_pasar/input'); ?>" method="POST">
                        ...
                        <div class="row justify-content-between text-left">
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex">
                                ...
                                <input type="text" class="form-control" name="nama_pasar" placeholder="Nama Pasar" autocomplete="off" value="<?= set_value('nama_pasar'); ?>">
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex">
                                ...
                                <input type="text" class="form-control" name="luas_lahan" placeholder="Luas Lahan" autocomplete="off" value="<?= set_value('luas_lahan'); ?>">
                                <div class="form-text text-danger"><?= form_error('luas_lahan') ?></div>
                            </div>
                            <div class="form-group col-sm-6 flex-column d-flex">
                                <label for="luas_bangunan">Luas Bangunan (m<sup>2</sup>)</label>
                                <input type="text" class="form-control" name="luas_bangunan" placeholder="Luas Bangunan" autocomplete="off" value="<?= set_value('luas_bangunan'); ?>">
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex">
                                ...
                                <input type="text" class="form-control" name="jml_pedagang" placeholder="Jumlah Pedagang" autocomplete="off" value="<?= set_value('jml_pedagang'); ?>">
                                <div class="form-text text-danger"><?= form_error('jml_pedagang') ?></div>
                            </div>
                            <div class="form-group col-sm-6 flex-column d-flex">
                                <label for="kios">Menempati Kios</label>
                                <input type="text" class="form-control" name="kios" placeholder="Jumlah pedagang yang menempati" autocomplete="off" value="<?= set_value('kios'); ?>">
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex">
                                ...
                                <input type="text" class="form-control" name="los" placeholder="Jumlah pedagang yang menempati" autocomplete="off" value="<?= set_value('los'); ?>">
                                <div class="form-text text-danger"><?= form_error('los') ?></div>
                            </div>
                            <div class="form-group col-sm-6 flex-column d-flex">
                                <label for="lapak">Menempati Lapak</label>
                                <input type="text" class="form-control" name="lapak" placeholder="Jumlah pedagang yang menempati" autocomplete="off" value="<?= set_value('lapak'); ?>">
                                <div class="form-text text-danger"><?= form_error('lapak') ?></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="omzet">Rata-Rata Omzet/bulan</label>
                            <input type="text" class="form-control" name="omzet" placeholder="Jumlah Omzet" autocomplete="off" value="<?= set_value('omzet'); ?>">
                            <div class="form-text text-danger"><?= form_error('omzet') ?></div>
                        </div>
                        <div class="form-group">
                            <label for="retribusi">Rata-Rata Retribusi/bulan</label>
                            <input type="text" class="form-control" name="retribusi" placeholder="Jumlah Retribusi" autocomplete="off" value="<?= set_value('retribusi'); ?>">
