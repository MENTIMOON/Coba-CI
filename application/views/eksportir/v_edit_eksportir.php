            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="" method="POST">
                        <input type="hidden" name="id" value="<?= $eksportir['id_eksportir']; ?>">
                        <div class="form-group">
                            <label for="nama_prshn">Nama Perusahaan</label>
                            <input type="text" class="form-control" name="nama_prshn" placeholder="Nama Perusahaan" value="<?= $eksportir['nama_prshn']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" data-live-search="true" name="desa" id="nmDesa" required>
                                ...
                                <?php foreach ($desa as $d) : ?>
                                    <?php if ($d['id_desa'] == $eksportir['id_desa']) : ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" data-live-search="true" name="kecamatan" id="nmKecamatan" required>
                                ...
                                <?php foreach ($kecamatan as $kec) : ?>
                                    <?php if ($kec['id_kecamatan'] == $eksportir['id_kecamatan']) : ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" data-live-search="true" name="kabupaten" id="nmKabupaten" required>
                                ...
                                <?php foreach ($kabupaten as $kab) : ?>
                                    <?php if ($kab['id_kabupaten'] == $eksportir['id_kabupaten']) : ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="komoditi" placeholder="Komoditi" value="<?= $eksportir['komoditi']; ?>">
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex">
                                ...
                                <select class="form-control selectpicker" name="jenis[]" multiple title="-Belum dipilih-">
                                    ...
                                    <?php foreach ($jenis as $j) : ?>
                                        <?php if ($j == $eksportir['jenis_prshn']) : ?>
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex">
                                ...
                                <select class="form-control selectpicker" data-live-search="true" name="skala_prshn" id="skalaPrshn" required>
                                    ...
                                    <?php foreach ($skala as $s) : ?>
                                        <?php if ($s['id_skala_prshn'] == $eksportir['id_skala_prshn']) : ?>
                                            <option value="<?= $s['id_skala_prshn']; ?>" selected><?= $s['skala_prshn']; ?></option>
                                        <?php else : ?>
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex">
                                ...
                                <input type="text" class="form-control" name="latitude" placeholder="Latitude" value="<?= $eksportir['latitude']; ?>">
                            </div>
                            <div class="form-group col-sm-6 flex-column d-flex">
                                <label for="longitude">Longitude</label>
                                <input type="text" class="form-control" name="longitude" placeholder="Longitude" value="<?= $eksportir['longitude']; ?>">
                            </div>
                        </div>
